...
* @{
*/
#define PRODUCT_KEY "de4ba99d70854d8a8470a7becdf5d9f0"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "23cd92a0f6284e45b9d7ef4e40eb071e"
...
#define LSENS_RATIO                         1
#define LSENS_ADDITION                      0
#define LSENS_MIN                           0
#define LSENS_MAX                           100
#define LSENS_LEN                           1
#define HOUR_RATIO                         1
