...
void userHandle(void)
{
    ...
    currentDataPoint.valueLSENS = adcx ;//Add Sensor Data Collection
    currentDataPoint.valueHOUR = current_hour;//Add Sensor Data Collection
